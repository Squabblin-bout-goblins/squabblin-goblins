...
UPSERT_SQL = """
INSERT INTO cards (id, name, mana_cost, type_line, oracle_text, set_code, set_name, rarity, price_usd, image_url, raw)
VALUES (%(id)s, %(name)s, %(mana_cost)s, %(type_line)s, %(oracle_text)s, %(set_code)s, %(set_name)s, %(rarity)s, %(price_usd)s, %(image_url)s, %(raw)s)
